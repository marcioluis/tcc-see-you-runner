...
namespace WindowsPhoneService
{
    ...
    public interface IWindowsPhoneService
    {
        ...
        [OperationContract]
        void AddPontos(int id, DateTime data, double velocidade, double distancia, double ritimo, double altitude, double calorias, int duracao, string longitude, string latitude, string isMetrico);
    }
